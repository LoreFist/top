...
class DictAllocation extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'cat', 'allocation_type', 'resort', 'resort_place', 'chage_baby', 'chage_small', 'chage_big', 'original', 'hotels_network', 'tophotels_cat',
              'updated', 'th_updated', 'noncertified_cat', 'geo', 'rooms_number', 'rooms_kind_number', 'blocks_number'], 'default', 'value' => null],
            [['id', 'cat', 'allocation_type', 'resort', 'resort_place', 'chage_baby', 'chage_small', 'chage_big', 'original', 'hotels_network', 'tophotels_cat',
              'updated', 'th_updated', 'noncertified_cat', 'geo', 'rooms_number', 'rooms_kind_number', 'blocks_number'], 'integer'],
